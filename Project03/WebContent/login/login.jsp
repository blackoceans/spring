...
<body>
		...
		<div id="login">
			...
			<div class="loginBody">
				...
				<div class="loginBodyBox3">
					<a href="../sub1/board.html" tabindex="195" class="showBalloon" title="로그인">로그인</a>
				</div>
				<div class="loginBodyBox4">
					<div class="loginBodyBox4-1">
						<a href="../sub2/qnaboard.html" tabindex="196" class="showBalloon" title="회원가입"><span><img src="../images/icoJoin.png" alt="ico-join"/>회원가입</span></a>
					</div>
					<div class="loginBodyBox4-2">
						<a href="../index.html" tabindex="197" class="showBalloon" title="아이디/비밀번호 찾기"><span>아이디/비밀번호 찾기</span></a>
					</div>
				</div>
			</div>
		</div>		
	...
	<section id="loginBottomInfo1" class="showBalloon" title="보안 프로그램">
		...
		<div class="loginBottomInfo1Box2">
			...
			<div class="installBox showBalloon" title="설치하기">
				<a href="../sub1/board.html" tabindex="198"><span class="installBoxImg"><img src="../images/icoKey.png" alt="ico-inst"/></span><span class="installBoxText">설치하기</span></a>
			</div>
		</div>
	...
	<section id="loginBottomInfo2">
		<div class="text">
			...
			<p><a href="../sub2/qnaboard.html" tabindex="199">이용안내</a> <a href="../sub1/board.html">이용약관</a></p>
		</div>
	</section>		
